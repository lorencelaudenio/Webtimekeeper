<footer class=" text-muted text-center text-small">
	<ul class="list-inline">
		...
		<li class="list-inline-item" data-toggle="modal" data-target="#myModal"><a href="#">Privacy</a></li>
		<li class="list-inline-item" data-toggle="modal" data-target="#myModal2"><a href="#">About</a></li>
